...
export const buildPlanningPrompt = buildArtifactPlanningPrompt;
export const buildDraftPrompt = buildArtifactDraftPrompt;
export const buildCritiquePrompt = buildArtifactCritiquePrompt;
export const buildRevisionPrompt = buildArtifactRevisionPrompt;
